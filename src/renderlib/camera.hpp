...
class camera {
    public:
    camera() : pos(0,0,0), U(1,0,0), V(0,1,0), W(0,0,1), focalLength(0.025f), imageplaneWidth(0.5f), imageplaneHeight(0.5f), nx(100), ny(100) {}

    camera(int pixel_nx, int pixel_ny) : pos(0,0,0), U(1,0,0), V(0,1,0), W(0,0,1), focalLength(.0625f), imageplaneWidth(0.5f), imageplaneHeight(0.5f), nx(pixel_nx), ny(pixel_ny) {}
